          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-2 gap-3">
                <label className="relative cursor-pointer">
                  ...
                  <div className={`p-4 border-2 rounded-lg text-center transition-all duration-200 ${
                    ...
                    <div className="text-xs">Book tours & connect with guides</div>
                  </div>
                </label>
                ...
                <label className="relative cursor-pointer">
                  ...
                  <div className={`p-4 border-2 rounded-lg text-center transition-all duration-200 ${
                    ...
                    <div className="text-xs">Offer tours & share local expertise</div>
                  </div>
                </label>
              </div>
            </div>
            ...
            <div>
              <button
                ...
                className="btn-primary w-full flex justify-center py-3 text-lg disabled:opacity-50"
              >
                {isSubmitting ? (
                  <>
